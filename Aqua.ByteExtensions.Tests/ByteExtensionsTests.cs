...
namespace Aqua.ByteExtensions.Tests
{
    public class ByteExtensionsTests
    {
        ...
        public void ToBytes_Boolean_Valid(byte[] expected,
                                          bool input) => Assert.Equal(expected, input.ToBytes());
        ...
        public void ToBytes_Char_Valid(byte[] expected,
                                       char input) => Assert.Equal(expected, input.ToBytes());
        ...
        public void ToBytes_Int_Valid(
            byte[] expected,
            int input) => Assert.Equal(expected, input.ToBytes());

        /// <summary>
        /// Sample data for test - ToBytes_Int_Valid
        /// </summary>
        public static IEnumerable<object[]> GetToBytesIntData() => new List<object[]>
            {
        ...
        public void ToBytes_Float_Valid(
            byte[] expected,
            float input) => Assert.Equal(expected, input.ToBytes());
        ...
        public void ToBytes_UShort_Valid(byte[] expected,
                                         float input) => Assert.Equal(expected, input.ToBytes());
        ...
        public void ToBytes_UInt_Valid(
            byte[] expected,
            uint input) => Assert.Equal(expected, input.ToBytes());

        /// <summary>
        /// Sample data for test - ToBytes_UInt_Valid
        /// </summary>
        public static IEnumerable<object[]> GetToBytesUintData() => new List<object[]>
            {
                        new object[]{ new byte[] { 0, 0, 0, 0 }, 0},
        ...
        public void ToBytes_ULong_Valid(byte[] expected,
                                        ulong input) => Assert.Equal(expected, input.ToBytes());

        /// <summary>
        /// Sample data for test - ToBytes_ULong_Valid
        /// </summary>
        public static IEnumerable<object[]> GetToBytesUlongData() => new List<object[]>
            {
                        new object[]{ new byte[] { 0, 0, 0, 0, 0, 0, 0, 0 }, 0},
        ...
        public void ToBytes_BooleanReversed_Valid(
            byte[] expected,
            bool input) => Assert.Equal(expected, input.ToBytesReversed());
        ...
        /// </summary>
        public static IEnumerable<object[]> GetToBytesCharReversedData() => new List<object[]>
            {
                        new object[]{new byte[] {0, 0}, null},
        ...
        public void ToBytes_DoubleReversed_Valid(
            byte[] expected,
            double input) => Assert.Equal(expected, input.ToBytesReversed());
        ...
        public void ToBytes_ShortReversed_Valid(byte[] expected,
                                                short input) => Assert.Equal(expected, input.ToBytesReversed());
        ...
        public void ToBytes_IntReversed_Valid(
            byte[] expected,
            int input) => Assert.Equal(expected, input.ToBytesReversed());

        /// <summary>
        /// Sample data for test - ToBytes_ShortReversed_Valid
        /// </summary>
        public static IEnumerable<object[]> GetToBytesIntReversedData() => new List<object[]>
            {
                        new object[]{ new byte[] { 0, 0, 0, 0 }, 0},
        ...
        public void ToBytes_FloatReversed_Valid(
            byte[] expected,
            float input) => Assert.Equal(expected, input.ToBytesReversed());

        /// <summary>
        /// Sample data for test - ToBytes_FloatReversed_Valid
        /// </summary>
        public static IEnumerable<object[]> GetToBytesFloatReversedData() => new List<object[]>
            {
                        new object[]{ new byte[] { 0, 0, 0, 0 }, 0},
        ...
        public void ToBytes_UShortReversed_Valid(byte[] expected,
                                                 float input) => Assert.Equal(expected, input.ToBytesReversed());

        /// <summary>
        /// Sample data for test - ToBytes_UShortReversed_Valid
        /// </summary>
        public static IEnumerable<object[]> GetToBytesUshortReversedData() => new List<object[]>
            {
                        new object[]{ new byte[] { 0, 0, 0, 0 }, 0},
                        new object[]{ new byte[] { 0, 0, 0, 0 }, ushort.MinValue},
        ...
        public void ToBytes_UIntReversed_Valid(
            byte[] expected,
            uint input) => Assert.Equal(expected, input.ToBytesReversed());
        ...
        public void ToBytes_ULongReversed_Valid(byte[] expected,
                                                ulong input) => Assert.Equal(expected, input.ToBytesReversed());
        ...
        /// </summary>
        public static IEnumerable<object[]> GetToBytesBigEndianData() => new List<object[]>
            {
                        new object[]{ new byte[] { 0, 0, 0, 0 }, 0},
                        new object[]{ new byte[] { 128, 0, 0, 0 }, int.MinValue},
                        new object[]{ new byte[] { 127, 255, 255, 255 }, int.MaxValue},
        ...
        public void ToBytesLittleEndian_Valid(
            byte[] expected,
        ...
        public void GetBytesAt_Valid(byte[] expected,
                                     byte[] input,
                                     int at,
                                     int n) => Assert.Equal(expected, input.GetBytesAt(at, n));
        ...
        public void Insert_Valid(byte[] expected,
                                 byte[] input,
                                 byte[] newBytes,
                                 int at) => Assert.Equal(expected, input.Insert(newBytes, at));
        ...
        public void Remove_Valid(
            ...
            byte[] input,
            int at,
            int n) => Assert.Equal(expected, input.Remove(at, n));

        /// <summary>
        /// Sample data for test - Remove_Valid
        /// </summary>
        public static IEnumerable<object[]> GetRemoveData() => new List<object[]>
            {
        ...
        public void ToHexString_Valid(string expected,
                                      byte[] input) => Assert.Equal(expected, input.ToHexString());

        /// <summary>
        /// Sample data for test - ToHexString_Valid
        /// </summary>
        public static IEnumerable<object[]> GetToHexStringData() => new List<object[]>
            {
                        new object[]{ "", null},
                        new object[]{ "", new byte[] { }},
        ...
        /// </summary>
        public static IEnumerable<object[]> GetToHexStringBase64Data() => new List<object[]>
            {
                        new object[]{ "", null},
                        new object[]{ "", new byte[] { }},
        ...
        public void IsHexStringCStyle_Valid(bool expected,
                                            string input) => Assert.Equal(expected, input.IsHexStringCStyle());

        /// <summary>
        /// Sample data for test - IsHexStringCStyle_Valid
        /// </summary>
        public static IEnumerable<object[]> GetIsHexStringCStyleData() => new List<object[]>
            {
                        new object[]{ false, null},
        ...
        /// </summary> 
        public static IEnumerable<object[]> GetBytes_Base64Data => new List<object[]>
            {
